...
<title>ORDER MEDICINES PAGE</title>
</head>
...
<h1 class="loginHeader">ORDER MEDICINES</h1>
<img alt="Login Image" src="Images/img26.png" class="orderMedicineImg">
<div class="loginForm">
<div>SELECT CITY</div>
...
<div>SELECT SHOP</div>
<select class="form-select formBorder" name="shopName">
<option selected disabled value="">Select Article</option>
</select><br>
<div>SELECT MEDICINES</div>
<select class="form-select formBorder" name="articlesName">
<option selected disabled value="">Select Medicines</option>
</select><br><br>
<button class="btn btn-info loginbtn" type="submit" ><strong>ORDER</strong></button>
</div>
